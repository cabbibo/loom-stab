...
ObjectControls.prototype.update = function(){
  ...
  if( this.intersected && this.oldIntersected == this.intersected ){
    if( this.intersected.hovering ){ this.intersected.hovering(this); }
  }
...
ObjectControls.prototype.getSingleIntersection = function( o ){
 
  var intersected =  this.raycaster.intersectObject( o , this.recursive );
